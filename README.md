...
> **강아현**
>
> 다소 짧았던 기간동안 진행되는 프로젝트이기 때문에 팀원들 간의 협업이 중요했는데, 안되는 부분이 있으면 어떻게든 해결을 해준 팀원들 덕분에 프로젝트를 마무리할 수 있었던 것 같다. 앞으로 프로젝트를 진행할 때 어떤 식으로 진행해야 좋을 지 감이 잡힌 것 같다. 다양한 이슈들을 경험하고 이를 처리하는 과정에서 배운 점들이 많았다. <br> _이 프로젝트는 웹으로만 구현이 되었지만 추후 앱으로도 구현해보면 좋을 것 같다._
