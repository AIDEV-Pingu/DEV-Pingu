...
def ocr_view(request, image_id):
    ...
    return render(request, 'main/ocr_result.html', {
...
def crawling_results_view(request):
    ...
    return render(request,'main/crawling_results.html',{'product_name':product_name, 'price':price, 'context':context,'site':site})
